...
class NotificationGalleryAddedTile extends StatefulWidget {
  bool isUnread;
  final Map<dynamic, dynamic> date;
  NotificationGalleryAddedTile(this.isUnread, this.date, {super.key});

  @override
  State<NotificationGalleryAddedTile> createState() =>
      _NotificationGalleryAddedTileState();
}

class _NotificationGalleryAddedTileState
    extends State<NotificationGalleryAddedTile> {
  String timeInString = "";
          ...
          child: Row(
            ...
            children: [
              ...
              Container(
                ...
                height: 50,
                decoration: BoxDecoration(
                  color: const Color.fromARGB(255, 226, 199, 254),
                  borderRadius: BorderRadius.circular(100),
                ),
                child: Icon(
                  Icons.image_outlined,
                  color: const Color.fromARGB(255, 136, 6, 217),
                ),
              ),
              // info
              SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'You have successfully added a new gallery.',
