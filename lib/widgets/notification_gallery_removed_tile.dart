...
class NotificationGalleryRemovedTile extends StatefulWidget {
  bool isUnread;
  final Map<dynamic, dynamic> date;
  NotificationGalleryRemovedTile(this.isUnread, this.date, {super.key});

  @override
  State<NotificationGalleryRemovedTile> createState() =>
      _NotificationGalleryRemovedTileState();
}

class _NotificationGalleryRemovedTileState
    extends State<NotificationGalleryRemovedTile> {
  String timeInString = "";
              ...
              SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'You have successfully removed gallery.',
