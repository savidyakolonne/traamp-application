            ...
            children: [
                      ...
                      Row(
                        ...
                        children: [
                          Icon(
                            ...
                            color: const Color.fromARGB(255, 44, 67, 135),
                          ),
                          Text(
                            "Languages",
                            style: TextStyle(
                            ...
                            Row(
                              ...
                              children: [
                                Icon(
                                  ...
                                  color: const Color.fromARGB(255, 223, 63, 52),
                                ),
                                Text(
                                  '${packageExclude[i]}',
                                  style: TextStyle(fontSize: 18),
                    ...
                    children: [
                      ...
                      if (widget.packageData['havePrivateTourOption'])
                        Row(
                          spacing: 10,
                          children: [
                            Icon(Icons.lock_person_sharp, color: Colors.green),
                            Text(
              ...
              SingleChildScrollView(
                ...
                child: Container(
                  ...
                  padding: EdgeInsets.all(8),
                  decoration: BoxDecoration(
                    color: const Color.fromARGB(255, 89, 40, 2),
                    border: BoxBorder.all(width: 1, color: Colors.green),
                    borderRadius: BorderRadius.circular(16),
                  ),
                  child: Row(
